...
public class ActTaskController extends BaseController {
	...
	public String todoList(Act act, HttpServletResponse response, Model model) throws Exception {
		...
		model.addAttribute("proDefinitions", actTaskService.getAllProcessDefinition());
	...
	public String propose(Act act, HttpServletRequest request, HttpServletResponse response, Model model) throws Exception {
		model.addAttribute("proDefinitions", actTaskService.getAllProcessDefinition());
		List<Act> list=actTaskService.propose(act);
		model.addAttribute("list",list);
		return "modules/act/proposeTask";
	}
	@RequestMapping(value = "detail")
	public String detail(Act act)
	{
		return "modules/act/detail";
	}
	...
	public String form(Act act, HttpServletRequest request, Model model){
		...
		if (act.getProcInsId() != null){
			ProcessInstance pi=actTaskService.getProcIns(act.getProcDefId());
			if(pi!=null)
			{
			...
			{
				act.setProcIns(actTaskService.getHisProcIns(act.getProcInsId()));
			}
			act.setProcIns(actTaskService.getProcIns(act.getProcInsId()));
		}
