...
//	private String procExecUrl; 	// 流程执行（办理）RUL
	...
	private HistoricProcessInstance historicProcessInstance;//历史流程
...
//	private Variable taskVars; 	// 流程任务变量
	...
	public void setProcIns(HistoricProcessInstance procIns) {
		this.procIns = null;
		if (procIns != null && procIns.getBusinessKey() != null){
			String[] ss = procIns.getBusinessKey().split(":");
			setBusinessTable(ss[0]);
...
//	}
	...
	public void setHistoticProcessInstance(HistoricProcessInstance historicProcessInstance) {
