...
//	private static Logger logger = LoggerFactory.getLogger(ActUtils.class);
	...
	public static final String[] PD_ADD_EXPENSE = new String[]{"process", "ExpenseClaimRecords"};
	public static final String[] PD_MODIFY_EXPENSE = new String[]{"modify_expenseRecords", "ExpenseClaimRecords"};
	public static final String[] PD_DELETE_EXPENSE = new String[]{"delete_process", "ExpenseClaimRecords"};
