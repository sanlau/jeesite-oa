...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="#">报销记录xiugai</a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="expenseclaimrecords" action="${ctx}/sys/expenseclaimrecords/modifySave" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="projectName" htmlEscape="false" maxlength="30" class="input-xlarge required" disabled="true"/>
				<span class="help-inline"><font color="red">*</font> </span>
			</div>
		</div>
		
		<div class="control-group">
			<label class="control-label">project_name1：</label>
			<div class="controls">
				<form:input path="projectName" htmlEscape="false" maxlength="30" class="input-xlarge required" disabled="true"/>
				<span class="help-inline"><font color="red">*</font> </span>
			</div>
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:textarea path="act.vars.map['remark']" htmlEscape="false" rows="4" maxlength="255" class="input-xxlarge "/>
			</div>
		</div>
