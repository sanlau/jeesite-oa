...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/sys/expenseclaimrecords/">报销记录修改</a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="expenseclaimrecords" action="${ctx}/sys/expenseclaimrecords/modifyAudit" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:textarea path="act.comment" htmlEscape="false" rows="4" maxlength="20" cssStyle="width:500px"/>
			</div>
		</div>
